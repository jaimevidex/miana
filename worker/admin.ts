    ...
    <div class="card" style="max-width:400px;margin:80px auto">
      ...
      <form id="login-form" class="grid" style="gap:16px">
        <div>
          ...
          <input id="email" name="email" type="email" required class="in" placeholder="hello@marianapita.pt" />
        </div>
        <div>
          <label class="lbl" for="password">Password</label>
          <input id="password" name="password" type="password" required class="in" placeholder="••••••••" />
        </div>
